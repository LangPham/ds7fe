...
describe('ProfilePageResearcherFormComponent', () => {
  ...
  describe('toggleProfileVisibility', () => {
    describe('', () => {
      beforeEach(() => {
        researcherProfileService.setVisibility.and.returnValue(
          createSuccessfulRemoteDataObject$(profile)
        );
      });
      ...
      it('should set the profile visibility to true', () => {
        ...
        expect(researcherProfileService.setVisibility).toHaveBeenCalledWith(
          profile,
          true
        );
      });
  ...
  describe('viewProfile', () => {
    it('should open the item details page', () => {
      ...
      expect(router.navigate).toHaveBeenCalledWith([
        'items',
        'a42557ca-cbb8-4442-af9c-3bb5cad2d075',
      ]);
    });
  });
});
